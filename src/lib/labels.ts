...
export const t = {
  ...
  practice: {
    ...
    check: 'Kontrolli',
    hint: 'Vihje',
    showSolution: 'Näita lahendust',
    showModel: 'Näita näidisvastust',
    yourAnswer: 'Sinu vastus',
    fillAll: 'Täida kõigepealt kõik lahtrid.',
    correct: 'Õige! ✓',
    wrong: 'Mõni vastus on veel vale (punasega). Proovi uuesti või vaata vihjet.',
  },
  sizeQuiz: {
